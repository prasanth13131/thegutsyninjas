...
<head>
	...
	<script>
		...
		{
		$(this).attr('href','customer.jsp');
		}
		else if(pwd="2345")
		{
		$(this).attr('href','engineer.jsp');
		}
		else
		{
		alert("Invalid vPIN")
...
    <a id="logintrigger" data-ajax="false" href="#" class="ui-btn ui-corner-all ui-shadow ui-icon-user ui-btn-icon-left ">Login</a>
</div>
  </div>
