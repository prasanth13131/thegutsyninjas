...
List<LinkedHashMap<String,String>> englist=db.getCustomers("N",ENGINEER_ID);
		...
		$(document).ready(function(){
			$('.newreq').click(function(){	
				...
				$.ajax({
					...
					type: 'GET',
					async: false,
					data: {enggId: enginid, requID: reid,ajaxReq: "updateRequest",status: "Y"},
...
<div data-role="page" data-theme="c">
  ...
  <div data-role="main" class="ui-content">
	      ...
	      <li data-role="divider">Take Up New Requests:</li>
	      <%
